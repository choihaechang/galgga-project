				    ...
				    <fieldset style="padding: 0px;">
						    <c:choose>
								<c:when test="${lod.lod_starpoint >= 1.0 && lod.lod_starpoint < 2.0}">
											...
											<input  type="radio" name="lod${o}" value="1" id="lod5" style="float:right;" checked readonly><label  for="#">★</label>					
								</c:when>
								<c:when test="${lod.lod_starpoint >= 2.0 && lod.lod_starpoint < 3.0}">
											...
											<input type="radio" name="lod${o}" value="2" id="lod4" checked readonly><label  for="#">★★</label>
								</c:when>
								<c:when test="${lod.lod_starpoint >= 3.0 && lod.lod_starpoint < 4.0}">
											...
											<input type="radio" name="lod${o}" value="3" id="lod3" checked readonly><label  for="#">★★★</label>		
								</c:when>
								<c:when test="${lod.lod_starpoint >= 4.0 && lod.lod_starpoint < 5.0}">
											<input  type="radio" name="lod" value="5" id="lod1" readonly><label  for="#">★</label>
											<input  type="radio" name="lod${o}" value="4" id="lod2" checked readonly><label  for="#">★★★★</label>
								</c:when>
								<c:when test="${lod.lod_starpoint eq 5.0}">
											<input  type="radio" name="lod${o}" value="5" id="lod1" checked readonly><label  for="#">★★★★★</label>
								</c:when> 
								<c:otherwise>
											<input type="radio" name="lod" value="5" id="lod1" readonly><label  for="#">★★★★★</label>
   ...
   <div style="font-size: 20px;"><strong>리뷰 제목 : </strong>${re.review_title }</div>
		...
		<c:choose>
			<c:when test="${re.starpoint eq '1'}">
						<input type="radio" name="starpoint" value="5" id="star1" readonly><label  for="#">★★★★</label>
						<input type="radio" name="starpoint${z }" value="1" id="star5" style="float:right;" checked readonly><label for="#">★</label>					
								
			</c:when>
			<c:when test="${re.starpoint eq '2'}">
						<input type="radio" name="starpoint" value="3" id="star3" readonly><label  for="#">★★★</label>
						<input type="radio" name="starpoint${z}" value="2" id="star4" checked readonly><label for="#">★★</label>
											
			</c:when>
			<c:when test="${re.starpoint eq '3'}">
											<input style=" cursor:pointer;" type="radio" name="starpoint" value="4" id="star2" readonly><label for="#">★★</label>
											<input style=" cursor:pointer;" type="radio" name="starpoint${z}" value="3" id="star3" checked readonly><label for="#">★★★</label>
			</c:when>
			<c:when test="${re.starpoint eq '4'}">
						<input type="radio" name="starpoint" value="5" id="star1" readonly><label for="#">★</label>
						<input type="radio" name="starpoint${z}" value="4" id="star2" checked readonly><label for="#">★★★★</label>
			</c:when>
			<c:when test="${re.starpoint eq '5'}">
						<input type="radio" name="starpoint${z}" value="5" id="star1" checked readonly><label for="#">★★★★★</label>								
			</c:when>
			<c:otherwise>
				<input style=" cursor:pointer;" type="radio" name="star" value="5" id="star1" readonly><label for="#">★★★★★</label>			
			</c:otherwise>
